            ...
            <div class="table-responsive">
                <table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer"
                    ...
                    <thead>
                        ...
                        <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                            ...
                            <th class="min-w-150px sorting" tabindex="0" aria-controls="kt_customers_table"
                                rowspan="1" colspan="1" aria-label="" style="width:100.591px;">
                                Actions
                            </th>
                        </tr>
                        <!--end::Table row-->
                    ...
                    <tbody class="fw-semibold text-gray-600">
                        <!--begin::Table row-->
                        @foreach ($emailApprovals as $emailAapprovalsData)
                            <tr class="odd">
                                <!--begin::Checkbox-->
                                <td>
                                ...
                                <td>
                                    <a href="#" class="text-gray-800 text-hover-primary mb-1">
                                        {{ $emailAapprovalsData->header }}
                                    </a>
                                </td>
                                <!--end::header  --->


                                <!--begin::emailtemplatename  --->
                                <td>
                                    <a href="#" class="text-gray-800 text-hover-primary mb-1">
                                        {{ optional($emailAapprovalsData->emailTemplate)->name ?? 'NULL' }}

                                    </a>
                                </td>
                                <!--end::emailtemplatename  --->
                                <!--begin::custom_msg  --->
                                <td>
                                    <a href="#" class="text-gray-800 text-hover-primary mb-1">
                                        {{ $emailAapprovalsData->custom_msg }}
                                    </a>
                                </td>
                                <!--end::custom_msg  --->
                                ...
                                <td>
                                    <a href="#" class="text-gray-800 text-hover-primary mb-1">
                                        {{ optional($emailAapprovalsData->emailSignature)->name ?? 'NULL' }}
                                ...
                                <td>
                                    <a href="#" class="text-gray-800 text-hover-primary mb-1">
                                        {{ $emailAapprovalsData->attachement ?? 'NULL' }}
                                    </a>
                                </td>
                                <!--end::attachement  --->
                                ...
                                <td>
                                    <a href="#" class="text-gray-800 text-hover-primary mb-1">
                                        {{ date(env('DATEFORMATE') . ' H:i:s', strtotime($emailAapprovalsData->datetime)) }}
                                    </a>
                                </td>
                                <!--end::datetime  --->
