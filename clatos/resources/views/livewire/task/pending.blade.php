            ...
            <div class="table-responsive">
                <table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer"
                    ...
                    <tbody class="fw-semibold text-gray-600">
                        <!--begin::Table row-->
                        @foreach ($taskPendingList as $taskPendingListData)
                            <tr class="odd">
                               
                                <!--begin::id --->
                                <td>
                                    <a href="#" class="text-gray-600 text-hover-primary mb-1">
                                        {{ $taskPendingListData->id }}
                                    </a>
                                </td>
                                <!--end::id --->
                                <!--begin::title --->
                                ...
                                <td>
                                    <a href="#" class="text-gray-600 text-hover-primary mb-1">
                                        {{ $taskPendingListData->assignedTo->name ?? 'NULL' }}
                                    </a>
                                </td>
                                <!--end::AssignedTo name  --->
                                ...
                                <td>
                                    <a href="#" class="text-gray-600 text-hover-primary mb-1">
                                        {{ $taskPendingListData->assignedBy->name ?? 'NULL' }}
                                    </a>
                                </td>
                                <!--end::AssignedBy name   --->
                                ...
                                <td>
                                     <a href="#" class="text-gray-600 text-hover-primary mb-1">
                                        {{ date(env('DATEFORMATE') . ' H:i:s', strtotime($taskPendingListData->datetime)) }}
