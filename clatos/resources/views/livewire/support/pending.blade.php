...
<div>
    ...
    <div class="card-body pt-0">
        ...
        <div id="kt_customers_table_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
            <div class="table-responsive">
                <table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer"
                    ...
                    <tbody class="fw-semibold text-gray-600">
                        <!--begin::Table row-->
                        @foreach ($supportPendingList as $supportPendingListData)
                            <tr class="odd">

                                <!--begin::User Id --->
                                <td>
                                    <a href="#" class="text-gray-600 text-hover-primary mb-1">
                                        {{ $supportPendingListData->id }}</a>
                                </td>
                                <!--end::User Id --->
                                ...
                                <td>
                                    <a href="#" class="text-gray-800 text-hover-primary mb-1">
                                        {{ $supportPendingListData->lead->name ?? 'NULL' }}
                                        {{ $supportPendingListData->lead->id ?? 'NULL' }}
                                    </a>
                                </td>
                                <!--end::lead Name --->
                                ...
                                <td>
                                    <a href="#" class="text-gray-600 text-hover-primary mb-1">
                                        {{ $supportPendingListData->ticketNumber }}</a>
                                ...
                                <td>
                                    <a href="#"
                                        class="text-gray-600 text-hover-primary mb-1">{{ $supportPendingListData->subject }}
                                    </a>
                                ...
                                <td>
                                    <a href="#"
                                        class="text-gray-600 text-hover-primary mb-1">{{ $supportPendingListData->product_id }}</a>
                                </td>
                                <!--end::product_id --->
                                ...
                                <td>
                                    <a href="#"
                                        class="text-gray-600 text-hover-primary mb-1">{{ $supportPendingListData->assignedTo->name ?? 'NULL' }}</a>
                                </td>
                                <!--end::assignTo_id --->
                                ...
                                <td>
                                    <a href="#"
                                        class="text-gray-600 text-hover-primary mb-1">{{ $supportPendingListData->assignedBy->name ?? 'NULL' }}</a>
                                </td>
                                <!--end::assignedBy_id --->
                                ...
                                <td>
                                    <a href="#" class="text-gray-600 text-hover-primary mb-1">
                                        @if ($supportPendingListData->preferredModeOfContact == 0)
                                            <a href="#" class="text-gray-600 text-hover-primary mb-1">Call</a>
                                        @elseif($supportPendingListData->preferredModeOfContact == 1)
                                ...
                                <td>
                                    <a href="#" class="text-gray-600 text-hover-primary mb-1">
                                        @if ($supportPendingListData->preferredTime == 0)
                                            <a href="#"
                                                class="text-gray-600 text-hover-primary mb-1">Morning</a>
                                        @elseif($supportPendingListData->preferredTime == 1)
                                            <a href="#"
                                                class="text-gray-600 text-hover-primary mb-1">Afternoon</a>
                                        @elseif($supportPendingListData->preferredTime == 2)
                                            <a href="#"
                                ...
                                <td>
                                    <a href="#" class="text-gray-600 text-hover-primary mb-1">
                                        @if ($supportPendingListData->status == 0)
                                            <a href="#"
                                                class="text-gray-600 text-hover-primary mb-1">Pending</a>
                                        @elseif($supportPendingListData->status == 1)
                                            <a href="#"
            ...
            {{-- {{ $supportPendingList->links('pagination::bootstrap-5') }} --}}
        </div>
        <!--end::Table-->
    </div>
    <!--end::Card body-->
