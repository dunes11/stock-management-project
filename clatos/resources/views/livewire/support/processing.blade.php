            ...
            <div class="table-responsive">
                <table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer"
                    ...
                    <tbody class="fw-semibold text-gray-600">
                        <!--begin::Table row-->
                        @foreach ($supportProcessingList as $supportProcessingListData)
                            <tr class="odd">

                                <!--begin::User Id --->
                                <td>
                                    <a href="#" class="text-gray-600 text-hover-primary mb-1">
                                        {{ $supportProcessingListData->id }}</a>
                                </td>
                                <!--end::User Id --->
                                ...
                                <td>
                                    <a href="#" class="text-gray-800 text-hover-primary mb-1">
                                        {{ $supportProcessingListData->lead->name ?? 'NULL' }}
                                        {{ $supportProcessingListData->lead->id ?? 'NULL' }}
                                    </a>
                                </td>
                                <!--end::lead Name --->
                                ...
                                <td>
                                    <a href="#" class="text-gray-600 text-hover-primary mb-1">
                                        {{ $supportProcessingListData->ticketNumber }}</a>
                                ...
                                <td>
                                    <a href="#"
                                        class="text-gray-600 text-hover-primary mb-1">{{ $supportProcessingListData->subject }}
                                    </a>
                                ...
                                <td>
                                    <a href="#"
                                        class="text-gray-600 text-hover-primary mb-1">{{ $supportProcessingListData->product_id }}</a>
                                </td>
                                <!--end::product_id --->
                                ...
                                <td>
                                    <a href="#"
                                        class="text-gray-600 text-hover-primary mb-1">{{ $supportProcessingListData->assignedTo->name ?? 'NULL' }}</a>
                                </td>
                                <!--end::assignTo_id --->
                                ...
                                <td>
                                    <a href="#"
                                        class="text-gray-600 text-hover-primary mb-1">{{ $supportProcessingListData->assignedBy->name ?? 'NULL' }}</a>
                                </td>
                                <!--end::assignedBy_id --->
                                ...
                                <td>
                                    <a href="#" class="text-gray-600 text-hover-primary mb-1">
                                        @if ($supportProcessingListData->preferredModeOfContact == 0)
                                            <a href="#" class="text-gray-600 text-hover-primary mb-1">Call</a>
                                        @elseif($supportProcessingListData->preferredModeOfContact == 1)
                                ...
                                <td>
                                    <a href="#" class="text-gray-600 text-hover-primary mb-1">
                                        @if ($supportProcessingListData->preferredTime == 0)
                                            <a href="#"
                                                class="text-gray-600 text-hover-primary mb-1">Morning</a>
                                        @elseif($supportProcessingListData->preferredTime == 1)
                                            <a href="#"
                                                class="text-gray-600 text-hover-primary mb-1">Afternoon</a>
                                        @elseif($supportProcessingListData->preferredTime == 2)
                                            <a href="#"
                                ...
                                <td>
                                    <a href="#" class="text-gray-600 text-hover-primary mb-1">
                                        @if ($supportProcessingListData->status == 0)
                                            <a href="#"
                                                class="text-gray-600 text-hover-primary mb-1">Pending</a>
                                        @elseif($supportProcessingListData->status == 1)
                                            <a href="#"
                                ...
                                <td>
                                    <a href="#" class="text-gray-600 text-hover-primary mb-1">
                                        {{date(env('DATEFORMATE').' H:i:s',strtotime($supportProcessingListData->datetime)) ?? 'NULL' }}
                                    </a>
                                </td>
                                <!-- end datetime  -->
