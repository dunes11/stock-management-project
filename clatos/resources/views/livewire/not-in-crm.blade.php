                    ...
                    <table class="table align-middle gs-0 gy-2  table-row-bordered table-hover">
                        ...
                        <thead class="bg-gray-800 text-gray-200 text-center">
                            <tr>
                                ...
                                <th class="p-2 min-w-150px text-capitalize ">datetime</th>
                                <th class="p-2 min-w-150px text-capitalize ">direction</th>
                                <th class="p-2 min-w-150px text-capitalize ">clientNumber</th>
                                <th class="p-2 min-w-150px text-capitalize ">agentNumber</th>
                                <th class="p-2 min-w-150px text-capitalize ">answerseconds</th>
                                <th class="p-2 min-w-150px text-capitalize ">agent_id</th>
                            </tr>
                            <!--end::Table row-->
                        </thead>
                        <!--end::Table head-->
                        ...
                        <tbody class="fw-semibold text-gray-600">
                            <!--begin::Table row-->
                            @foreach ($notInCrm as $notInCrmData)
                                <tr class="">
                    
                                    <!--begin::datetime  --->
                                    <td>
                                        <a href="#" class="text-gray-600 text-hover-primary mb-1">
                                            {{ date(env('DATEFORMATE') . ' H:i:s', strtotime($notInCrmData->datetime)) }}
                                    ...
                                    <td>
                                        <a href="#" class="text-gray-800 text-hover-primary mb-1">
                                            {{ $notInCrmData->agentNumber }}
                                        </a>
                                    </td>
                                    <!--end::agentNumber  --->

                                    <!--begin::answeredSeconds  --->
                                    <td>
                                        <a href="#" class="text-gray-800 text-hover-primary mb-1">
                                            {{ $notInCrmData->answeredSeconds }}
                                        </a>
                                    </td>
                                    <!--end::answeredSeconds  --->
                                    ...
                                    <td>
                                        <a href="#" class="text-gray-800 text-hover-primary mb-1">
                                            {{ $notInCrmData->agentName->name ?? 'NULL' }}
                                        </a>
                                    </td>
                                    <!--end::agentname --->
                                </tr>
