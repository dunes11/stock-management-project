            ...
            <div class="table-responsive">
                <table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer"
                    ...
                    <tbody class="fw-semibold text-gray-600">
                        <!--begin::Table row-->
                        @foreach ($upcomingTickets as $upcomingTicketsData)
                            <tr class="odd">

                                <!--begin::datetime --->
                                <td>
                                    <a href="#" class="text-gray-600 text-hover-primary mb-1">
                                        {{ date(env('DATEFORMATE') . ' H:i:s', strtotime($upcomingTicketsData->datetime)) }}
                                    </a>
                                </td>
                                <!--end::datetime --->
                                ...
                                <td>
                                    <a href="#" class="text-gray-800 text-hover-primary mb-1">
                                        {{ optional($upcomingTicketsData->assignedto)->name ?? 'NULL' }}
                                ...
                                <td>
                                    <a href="#" class="text-gray-800 text-hover-primary mb-1">
                                        {{ optional($upcomingTicketsData->assignedby)->name ?? 'NULL' }}
