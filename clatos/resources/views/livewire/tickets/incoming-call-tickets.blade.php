            ...
            <div class="table-responsive">
                <table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer"
                    ...
                    <tbody class="fw-semibold text-gray-600">
                        <!--begin::Table row-->
                        @foreach ($incomingCallTickets as $incomingCallTicketsData)
                            <tr class="odd">

                                <!--begin::datetime --->
                                <td >
                                    <a href="#" class="text-gray-600 text-hover-primary mb-1">
                                        {{ date(env('DATEFORMATE') . ' H:i:s', strtotime($incomingCallTicketsData->datetime)) }}
                                    </a>
                                </td>
                                <!--end::datetime --->
                                ...
                                <td >
                                    <a href="#" class="text-gray-600 text-hover-primary mb-1">
                                        {{ optional($incomingCallTicketsData->lead)->name ?? 'NULL' }},
                                        {{ $incomingCallTicketsData->lead_id }}
                                    </a>
                                </td>
                                <!--end::leadname  --->
                                ...
                                <td >
                                    <a href="#" class="text-gray-600 text-hover-primary mb-1">
                                        {{ $incomingCallTicketsData->purpose }}
                                    </a>
                                </td>
                                <!--end::purpose  --->


                                <!--begin::assignedtoname  --->
                                <td >
                                    <a href="#" class="text-gray-600 text-hover-primary mb-1">
                                        {{ optional($incomingCallTicketsData->assignedto)->name ?? 'NULL' }}

                                    </a>
                                </td>
                                <!--end::assignedtoname  --->

                                <!--begin::assignedbyname  --->
                                <td >
                                    <a href="#" class="text-gray-600 text-hover-primary mb-1">
                                        {{ optional($incomingCallTicketsData->assignedby)->name ?? 'NULL' }}
