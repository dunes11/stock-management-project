                ...
                <table class="table align-middle table-row-dashed fs-6 gy-3 dataTable no-footer"
                    ...
                    <thead>
                        ...
                        <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                            ...
                            <th wire:click="" class="min-w-15px sorting" tabindex="0"
                            ...
                            <th wire:click="" class="min-w-15px sorting" tabindex="0"
                                ...
                                style="width: 20px;">
                                Cart Items</th>
                            <th class="min-w-15px sorting" tabindex="0" aria-controls="kt_customers_table"
                                rowspan="1" colspan="1" aria-label="" style="width:20px;">
                                Assigned To</th>
                        </tr>
                        <!--end::Table row-->
                    </thead>
                    ...
                    <tbody class="fw-semibold text-gray-600">
                        <!--begin::Table row-->
                        @foreach ($cartleads as $cartleadsData)
                            <tr class="odd">
                                <!--begin::leadname,id  --->
                                <td>
                                    <a href="#" class="text-gray-600 text-hover-primary mb-1">
                                        {{ optional(cartleadsData->lead)->name ?? 'NULL' }},
                                        {{ cartleadsData->lead_id }}
                                    </a>
                                </td>
                                <!--end::leadname,id  --->
                                <!--begin::card Items --->
                                ...
                                <td>
                                    <a href="#" class="text-gray-600 text-hover-primary mb-1">
                                        {{ optional(cartleadsData->assignedto)->name ?? 'NULL' }}
                                    </a>
                                </td>
                                <!--end::assignedtoname  --->
                            </tr>
