            ...
            <div class="table-responsive">
                <table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer"
                    ...
                    <tbody class="fw-semibold text-gray-600">
                        <!--begin::Table row-->
                        @foreach ($dueTickets as $dueTicketsData)
                            <tr class="odd">

                                <!--begin::datetime --->
                                <td >
                                    <a href="#" class="text-gray-600 text-hover-primary mb-1">
                                        {{ date(env('DATEFORMATE') . ' H:i:s', strtotime($dueTicketsData->datetime)) }}
                                    </a>
                                </td>
                                <!--end::datetime --->
                                ...
                                <td >
                                    <a href="#" class="text-gray-600 text-hover-primary mb-1">
                                        {{ optional($dueTicketsData->lead)->name ?? 'NULL' }},
                                        {{ $dueTicketsData->lead_id }}
                                    </a>
                                </td>
                                <!--end::leadname  --->
                                ...
                                <td >
                                    <a href="#" class="text-gray-600 text-hover-primary mb-1">
                                        {{ optional($dueTicketsData->assignedto)->name ?? 'NULL' }}
                                ...
                                <td >
                                    <a href="#" class="text-gray-600 text-hover-primary mb-1">
                                        {{ optional($dueTicketsData->assignedby)->name ?? 'NULL' }}
